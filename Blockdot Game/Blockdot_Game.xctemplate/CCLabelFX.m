          ...
          shadowOffset:(CGSize)shadowSize shadowBlur:(float)shadowBlur shadowColor:(ccColor4B)sColor fillColor:(ccColor4B)fColor
{
	return [[self alloc] initWithNSString: string dimensions:dimensions alignment:alignment fontName:name fontSize:size shadowOffset:shadowSize 
                                shadowBlur:shadowBlur shadowColor:sColor fillColor:fColor];
}
...
{
	return [[self alloc] initWithNSString: string dimensions:dimensions alignment:alignment fontName:name fontSize:size shadowOffset:shadowSize shadowBlur:shadowBlur];
}
...
{
	return [[self alloc] initWithNSString: string fontName:name fontSize:size shadowOffset:shadowSize shadowBlur:shadowBlur];
}
